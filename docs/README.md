...
- 現在は次の領域を業務の中心としており、お手伝いできることが多いと考えています
  - クラウドネイティブ
  - コンテナ/kubernetes
...
- オフィスワーク・フルリモートワークどちらも適宜使い分けが可能です
  - 参画の初期段階では対面でのコミュニケーションが適しており、オフィスワーク中心が良いと考えています
- 本業の比率を大きく下げることが難しいため、最大月60時間〜80時間を目安に調整させていただければと思います
  - このため必然的にコンサルテーション等に比重をおいたものが多くなるかと思います
  - ツール開発や構築・設計・移行作業など比較的長い拘束を伴うものは応相談にて対応させていただきます
  - 設計（システム以外に組織なども含む）のレビューや壁打ちが始めやすいかもしれません
