...
- 必ずしもフルリモートワークである必要性はありませんが、必要に応じてオフィス・リモートが柔軟に選択できることができれば幸いです
- 週8時間稼働(月40時間程度)でのご支援から始められると幸いです
  - このため必然的にコンサルテーション等に比重をおいたものが多くなるかと思います
  - ツール開発や構築・設計・移行作業など比較的長い拘束を伴うものは少し支援を行ったのちに相談しつつ実施できると思います
