...
- 現在は次の領域を業務の中心としています
  ...
  - Observability
- インフラ運用の領域で効率化ツールを書くことを好みます
  - しばしば車輪の再発見になりますが機動的な運用に貢献できる能力だと考えています
...
- (過去)泥臭いPM業 → (今)スタートアップ的/小さな組織の軽量な仕事の仕方を好む/広める
...
- グローバル(日本や海外)でのエンジニアリングを志向し英語を絡めた転職活動をして現職に参画
...
- ネットワークエンジニアからのキャリア転換を目指して転職
  - SIer的な仕事からスタートアップのグルーブを理解に当初は苦戦
- とても大変だったが非常に様々な経験が出来た現場
  - 大変が故にインフラエンジニアの大変さを如何に軽減すべきかを深く考えることをきっかけに
